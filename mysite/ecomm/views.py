...
from .serializers import UserSerializer, LoginSerializer, AdminUserSerializer,  ProductSerializer, CategorySerializer, CartSerializer, CartItemSerializer, ContactInfoSerializer, ProfileSerializer, OrderSerializer
from rest_framework.response import Response
from rest_framework import permissions
from rest_framework.generics import CreateAPIView, ListAPIView, RetrieveAPIView, UpdateAPIView, DestroyAPIView
from .models import CustomUser, Product, Product, Category, Cart, CartItem, ContactInfo, Profile, Order
